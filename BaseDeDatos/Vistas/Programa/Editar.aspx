<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Editar.aspx.cs" Inherits="BaseDeDatos.Vistas.Programa.Editar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <body>
        <h2>Editar <small>Programa</small></h2>
        <asp:ValidationSummary ID="vsEditarProvincias" runat="server" ForeColor="Red" />
        <asp:HiddenField ID="hdfIdPrograma" runat="server" />
        <table>
            <tr>
