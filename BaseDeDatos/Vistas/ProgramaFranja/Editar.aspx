<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Editar.aspx.cs" Inherits="BaseDeDatos.Vistas.ProgramaFranja.Editar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <body>
        <asp:HiddenField ID="hdfProgramaFranjaId" runat="server" />
        <h2>Editar <small>Programa - Franja </small></h2>
        <asp:ValidationSummary ID="vsEditarProgramaFranja" runat="server" ForeColor="Red" />
        <table>
            <tr>
        ...
        <div class="form-actions">
            ...
            <asp:Button ID="btnGuardar" runat="server" Text="Guardar" CssClass="btn btn-primary" OnClick="btnCrear_Click" />
        </div>
