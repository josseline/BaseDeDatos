<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Editar.aspx.cs" Inherits="BaseDeDatos.Vistas.Contrato.Editar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <body>
        <h2>Editar <small>Contrato</small></h2>
         <asp:ValidationSummary ID="vsEditarContrato" runat="server" ForeColor="Red" />
        <table>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtContrado" runat="server" MaxLength="200" CssClass="form-control" Enabled="false"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="rfvContrato" runat="server" ErrorMessage="Debe ingresar Contrato" ForeColor="Red" ControlToValidate="txtContrado">*</asp:RequiredFieldValidator>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtNifPatrocinador" runat="server" MaxLength="50" CssClass="form-control" Enabled="false"></asp:TextBox>
                </td>
                <td>
                    <asp:TextBox ID="txtNombrePatrocinador" runat="server" MaxLength="50" CssClass="form-control" Enabled="false" Width="200"></asp:TextBox>

                </td>
                <td>
                    <asp:RequiredFieldValidator ID="rfvPatrocinador" runat="server" ErrorMessage="Debe ingresar un Patrocinador" ForeColor="Red" ControlToValidate="txtNifPatrocinador">*</asp:RequiredFieldValidator>
