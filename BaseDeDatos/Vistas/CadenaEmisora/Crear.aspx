<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Crear.aspx.cs" Inherits="BaseDeDatos.Vistas.CadenaEmisora.Crear" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <body>
        <h2>Crear <small>Cadena - Emisora </small></h2>
        <asp:ValidationSummary ID="vsCrearCadenaEmisora" runat="server" ForeColor="Red" />
         <table>
            <tr>
                ...
                <td>
                    <button id="btnBuscarCadena" class="btn btn-warning BuscarCadena"  data-target="#buscarCadena" onclick="return false">+</button>
                </td>
            ...
            <tr>
                ...
                <td>
                    <button id="btnBuscarEmisora" class="btn btn-warning BuscarEmisora"  data-target="#buscarEmisora" onclick="return false">+</button>
                </td>
              ...
              <tr>
                ...
                <td>
                  <asp:RequiredFieldValidator ID="rfvDirector" runat="server" ErrorMessage="Debe seleccionar un director" ForeColor="Red" Width="5" ControlToValidate="txtNifRep">*</asp:RequiredFieldValidator>
                </td>
                <td>
