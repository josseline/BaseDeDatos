<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Crear.aspx.cs" Inherits="BaseDeDatos.Vistas.MediosComunicacion.Crear" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <body>
        <h2>Crear <small>Medio Comunicacion</small></h2>
        <asp:ValidationSummary ID="vsCrearMedioComunicacion" runat="server" ForeColor="Red" />
        <table>
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="rfvNif" runat="server" ErrorMessage="Debe ingresar un NIF para el medio de comunicación" ForeColor="Red" ControlToValidate="txtNif">*</asp:RequiredFieldValidator>
