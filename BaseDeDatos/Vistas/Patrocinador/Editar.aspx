<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Editar.aspx.cs" Inherits="BaseDeDatos.Vistas.Patrocinador.Editar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Editar <small>Patrocinador</small></h2>
    <asp:ValidationSummary ID="vsEditarPatrocinador" runat="server" ForeColor="Red"/>
