<%@ Page Title="Administración de la Cuenta" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="BaseDeDatos.Account.Manage" %>
        ...
        <div class="col-md-12">
            <section id="passwordForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                ...
                                <asp:CompareValidator runat="server" ControlToCompare="Password" ControlToValidate="confirmPassword"
                                    CssClass="text-error" Display="Dynamic" ErrorMessage="La contraseña y confirmacion de contraseña no coinciden"
                                    ValidationGroup="SetPassword" />
                ...
                <asp:PlaceHolder runat="server" ID="changePasswordHolder" Visible="false">
                    <p>Esta logueado como <strong><%: User.Identity.GetUserName() %></strong>.</p>
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                ...
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="ConfirmNewPassword"
                                    CssClass="text-danger" Display="Dynamic" ErrorMessage="La confirmacion de la nueva contraseña es requerida"
                                    ValidationGroup="ChangePassword" />
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-10">
                                <asp:Button runat="server" Text="Cambiar Contraseña" ValidationGroup="ChangePassword" OnClick="ChangePassword_Click" CssClass="btn btn-primary" />
                            </div>
                        </div>
                    </div>
                </asp:PlaceHolder>
